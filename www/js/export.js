...
createSection("export", `
   ...
   класс»).</li>
   <li>Журналы учета внеурочной деятельности в межклассных группах экспортируются педагогами, проводящими занятия в этих группах (ссылка «Экспорт» справа от названия группы в интерфейсе учителя).</li></ol>
`);
